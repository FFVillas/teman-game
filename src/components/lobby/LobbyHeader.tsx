        ...
        <div className="flex flex-wrap items-center gap-3 border-t border-border-subtle pt-5">
          {isLeader ? (
            <>
              ...
              <Link
                href={`/lfg/${lobby.game}/create`}
                className="flex h-10 items-center justify-center rounded-lg border border-border-strong px-5 text-xs font-semibold text-text-muted transition-colors hover:text-white"
              >
                Edit details
              </Link>
            </>
