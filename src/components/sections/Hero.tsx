  ...
  return (
    <section className="flex flex-col items-center px-6 pt-16 pb-20 text-center">
      ...
      <p className="mt-4 max-w-[698px] text-base text-text-muted sm:text-lg">
        Connect with thousands of players worldwide. Filter by rank, role, and
        playstyle to dominate the leaderboard in your favorite competitive
        games.
      </p>

      <div className="mt-16 grid w-full max-w-[1168px] grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-5">
        {games.map((game) => (
